...
(function ($) {
    ...
    var portfolioIsotope = function () {
        if ($().isotope) {
            ...
            // Isotope cho container .portfolio-wrap2 (chá»‰ vá»›i layoutMode: "masonry" vÃ  itemSelector)
            var $container2 = $(".portfolio-wrap2").isotope({
                layoutMode: "masonry", // Chá»‰ sá»­ dá»¥ng masonry layout mode
                itemSelector: ".item", // Chá»n item cÃ³ class "item"
            });

            // Load more cho .portfolio-wrap
            $("#load-more").on("click", function () {
                var $hiddenItems = $(".item.hidden").slice(0, 3); // Láº¥y 3 item má»—i láº§n
            ...
            // Xá»­ lÃ½ filter cho cáº£ 2 container
...
document.querySelectorAll(".counter").forEach(counter => {
  ...
  let count = 0;
  let step = target / 50; // speed control
...
const tabs = document.querySelectorAll(".product-categories li");
...
//         list.classList.add("active");
//         // trigger animation
//         list.querySelectorAll(".product-item").forEach((item, i) => {
